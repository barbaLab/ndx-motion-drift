...
# Next Steps for ndx-motion-drift Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-motion-drift directory: `cd ndx-motion-drift`
...
`spec/ndx-motion-drift.namespace.yaml` and
`spec/ndx-motion-drift.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_motion_drift/__init__.py` includes an
...
`src/pynwb/ndx_motion_drift/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_motion_drift/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_motion_drift/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-motion-drift
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/FrancescoNegri/ndx-motion-drift/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-motion-drift/0.1.0
...
`staged-extensions/ndx-motion-drift`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-motion-drift
    ```

13. Edit `staged-extensions/ndx-motion-drift/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/FrancescoNegri/ndx-motion-drift
      pip: https://pypi.org/project/ndx-motion-drift/
      license: MIT
      maintainers: 
        - FrancescoNegri
      ```

14. Edit `staged-extensions/ndx-motion-drift/README.md`
to add information about your extension. You may copy it from
`ndx-motion-drift/README.md`.

  ```bash
  cp ndx-motion-drift/README.md staged-extensions/ndx-motion-drift/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-motion-drift
git commit -m "Add new catalog entry for ndx-motion-drift" .
git push
```
...
ndx-motion-drift-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-motion-drift GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-motion-drift-record repository on GitHub.
